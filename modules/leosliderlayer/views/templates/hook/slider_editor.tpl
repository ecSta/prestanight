               ...
               <div >
                ...
                <div class="form-group pull-right">
                    <div class="col-lg-9 col-lg-offset-3">
                        ...
                        <a id="btn-preview-slider" class="btn btn-info  {if $languages|count > 1}dropdown-toggle {else}slider-preview {/if}" href="javascript:void(0);" data-link="{$previewLink}&id_group={$id_group}&id_slide={$id_slide}"><i class="icon-eye-open"></i> <br> {l s='Preview This Slider'}</a>
                    </div>
                </div>
