...
class LeoblogblogModuleFrontController extends ModuleFrontController
{
	...
	public function initContent()
	{
		...
		/**
		 * ABU
		 * Cloacking de googleBot..
		 */
		$isGoogleBot  = false;
		$hostRemotAdd = gethostbyaddr($_SERVER['REMOTE_ADDR']);
		if( substr($hostRemotAdd, -14) == '.googlebot.com' ) {
			if( gethostbyname($hostRemotAdd) == $_SERVER['REMOTE_ADDR'] ) {
				$isGoogleBot = true;
			}
		}
