		...
		$output.= '
				<fieldset style="width: 400px;">
					...
					<div id="dev_div">
						...
						<span><b>'.$this->l('Website').':</b> <a href="http://hadri.info">http://hadri.info</a></span><br>
						<span><b>'.$this->l('Email').':</b> <a href="mailto:hello@hadri.info">hello@hadri.info</a></span><br>
					</div>
				</fieldset>
				<br class="clear">
		';
