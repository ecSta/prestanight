...
<div id="listpage_content" class="row">
    ...
    <div class="col-xs-12 col-sm-6">
        <div class="sitemap_block box">
            <h3 class="page-subheading">{l s='Guide'}</h3>
            <ul>
                {foreach from=$listblogs item=blog name=bloglist}
                <li>
                    <a href="{$blog.helperLink|escape:'html':'UTF-8'}" title="{$blog.meta_title|escape:'html':'UTF-8'}">
