...
<div style="line-height: 1pt">&nbsp;</div>
<table style="width: 100%; font-size: 5pt; font-weight: lighter;">
	<tr>
		<td style="width: 17%"></td>
		<td style="width: 83%">Tous les produits livrés peuvent faire l'objet d'un remboursement dans le cadre du droit de rétractation, excepté les produits ayant été confectionnés selon les spécifications du client : les produits issus de la gamme "sur-mesure" qui font l'objet d'une personnalisation et d’une fabrication spéciale chez notre fournisseur et les services ayant été déjà réalisés. Les produits doivent être en état neuf, complets, et emballés dans leur emballage d'origine. Le client dispose d’un délai de 15 jours francs à partir de la réception du dernier colis de la commande, et à partir du lendemain de l’acceptation de l’offre dans le cas des prestations de service, pour notifier sa décision de rétractation en lettre recommandée avec accusé de réception à l’adresse suivante: <br />
SONUIT 18 chemin du Clos 06530 PEYMEINADE - France <br />( voir formulaire type de rétractation dans les conditions générales de vente)</td>
	</tr>
</table>
