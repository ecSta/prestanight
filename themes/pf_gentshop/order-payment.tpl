		...
		<div class="paiement_block">
			<div id="HOOK_TOP_PAYMENT">{$HOOK_TOP_PAYMENT}</div>
				{if $HOOK_PAYMENT}
					...
					<h4 class="well text-center text-danger">{l s='Please notice that it preferred to use the payment by bank transfer (for purchases over € 1,000) to avoid reaching the payment limit of your credit card.'}</h4>
