    ...
    {else}
        ...
        <form action="{$link->getPageLink('identity', true)|escape:'html':'UTF-8'}" method="post" class="std form-horizontal">
            ...
            {$HOOK_CUSTOMER_IDENTITY_FORM}
                <div class="form-group">
					<div class="col-sm-offset-4 col-sm-8">
                    <button type="submit" name="submitIdentity" class="btn btn-outline-default">
...
<ul class="footer_links clearfix">
	<li class="pull-left">
        <a class="btn btn-outline-default" href="{$link->getPageLink('my-account', true)}">
            <span>
	...
	<li class="pull-right">
        <a class="btn btn-outline-default" href="{$base_dir}">
            <span>
